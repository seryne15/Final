...
public class KinectManager : MonoBehaviour
{
    ...
    private List<KinectGestures.GestureData> player1GesturesCopy = new List<KinectGestures.GestureData>();
    ...
    void Update()
    {
        ...
        if (KinectInitialized)
        {
            ...
            if (Player1Calibrated)
            {
                ...
                player1GesturesCopy = player1Gestures;
                foreach (KinectGestures.GestureData gestureData in player1GesturesCopy.ToArray())
                {
