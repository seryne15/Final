...
public class ScorringBox : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                timer = scorePredit * (2.32f);
                timerText.text = "00:00";
            }

        }
        scoreText.text = EnterBox.score.ToString();
        score = 0;;
    }
    ...
    void Update()
    {
         score = EnterBox.score;

        //scoreText.text = (EnterBox.score * 8).ToString();
         scoreText.text = EnterBox.score.ToString();
